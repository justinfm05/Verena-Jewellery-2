		...
		<?php else : ?>
			...
			>
				...
				<div class="bullion-detail__form">
					...
					<div class="form-field">
						<label for="ubs-qty">Jumlah</label>
						<select id="ubs-qty" x-model="quantity">
			...
			<div class="price-history" style="margin-top:var(--space-5);">
				...
				<?php
				$ubs_changed_at = $sheet['changed_at']['ubs'] ?? null;
				if ( $ubs_changed_at ) :
					?>
					<p class="text-muted" style="font-size:0.85rem;">Harga terakhir diperbarui: <?php echo esc_html( wp_date( 'j F Y, H:i', $ubs_changed_at, new DateTimeZone( 'Asia/Jakarta' ) ) . ' WIB' ); ?></p>
				<?php endif; ?>
			</div>
